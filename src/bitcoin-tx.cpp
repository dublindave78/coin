...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " mmm-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  mmm-tx [options] <hex-tx> [commands]  Update hex-encoded mmm transaction\n" +
            "or:     mmm-tx [options] -create [commands]   Create hex-encoded mmm transaction\n" +
            "\n";
