...
#if defined(NDEBUG)
#error "MMM cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "MMM Signed Message:\n";
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
    ...
    CAmount nSubsidy = 1313 * COIN;
    if (nHeight == 1)
        return nSubsidy = 131313131 * COIN;
