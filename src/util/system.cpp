...
const char * const BITCOIN_CONF_FILENAME = "mmmcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "MMM";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/MMM";
#else
    // Unix
    return pathRet / ".mmm";
#endif
