    ...
    if (request.fHelp || request.params.size() != 2 ||
        ...
        throw std::runtime_error(
            RPCHelpMan{
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("addnode", "\"192.168.0.6:11917\" \"onetry\"") + HelpExampleRpc("addnode", "\"192.168.0.6:11917\", \"onetry\"")},
            }
                .ToString());
    ...
    if (request.fHelp || request.params.size() == 0 || request.params.size() >= 3)
        throw std::runtime_error(
            RPCHelpMan{
                ...
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("disconnectnode", "\"192.168.0.6:11917\"") + HelpExampleCli("disconnectnode", "\"\" 1") + HelpExampleRpc("disconnectnode", "\"192.168.0.6:11917\"") + HelpExampleRpc("disconnectnode", "\"\", 1")},
            }
                .ToString());
        ...
        throw std::runtime_error(
            RPCHelpMan{
                ...
                RPCResult{
                    ...
                    "       {\n"
                    "         \"address\" : \"192.168.0.201:11917\",  (string) The mmm server IP and port we're connected to\n"
